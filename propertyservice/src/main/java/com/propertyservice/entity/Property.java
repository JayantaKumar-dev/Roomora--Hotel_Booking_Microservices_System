...
public class Property {
	...
	@Column(name="property_owner_language")
	private String propertyOwnerLanguage;
	...
	public String getPropertyOwnerLanguage() {
		return propertyOwnerLanguage;
	}
	public void setPropertyOwnerLanguage(String propertyOwnerLanguage) {
		this.propertyOwnerLanguage = propertyOwnerLanguage;
	}
